// Não retorna novo array, retorna um valor único -> Muito bom para matemática
const videos = [{
  id: 'p9mqWsPJEY4',
...
const sumOfVideoViews = videos.reduce((sum, video) => { return sum + video.views}, 0);
console.log(sumOfVideoViews);